...
For a full configuration reference, see https://developers.openai.com/codex/config-reference.
...
| `experimental_supported_tools`                   | array<string>                                                     | Extra experimental built-in tools to enable (e.g. `["read_file"]`).                                                             |
