...
pub(crate) struct SessionConfiguration {
    ...
    /// The client-selected mode. `None` preserves omission so an eligible
    /// Ultra root can derive proactive delegation without overriding an
...
impl SessionConfiguration {
    ...
    pub(super) fn thread_config_snapshot(&self) -> ThreadConfigSnapshot {
        ThreadConfigSnapshot {
            ...
            multi_agent_mode: self.multi_agent_mode.unwrap_or_default(),
