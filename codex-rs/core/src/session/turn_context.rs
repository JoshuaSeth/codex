...
pub struct TurnContext {
    ...
    /// Endpoint-backed recommendations are ephemeral, but every sampling
    /// request in this turn must use the same filtered candidate snapshot as
    /// the model-visible contextual fragment.
    pub(crate) recommended_plugin_candidates: Arc<OnceCell<Option<Vec<DiscoverableTool>>>>,
...
impl TurnContext {
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            recommended_plugin_candidates: Arc::clone(&self.recommended_plugin_candidates),
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        TurnContext {
            ...
            recommended_plugin_candidates: Arc::new(OnceCell::new()),
