...
impl AuthBrokerClient {
    ...
    pub(crate) fn new(config: AuthBrokerConfig) -> Self {
        Self {
            config,
    ...
    pub(crate) fn new_for_testing(url: String, token: String) -> Self {
        Self::new(AuthBrokerConfig {
            url,
            token,
            client_name: "codex-dev-test".to_string(),
            lease_reason: "usage-limit-recovery-test".to_string(),
