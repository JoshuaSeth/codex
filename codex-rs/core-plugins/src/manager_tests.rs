...
"#,
    ...
    let unauthenticated_cache_key = recommended_plugins_cache_key(&config, /*auth*/ None);
    assert_ne!(cache_key, unauthenticated_cache_key);
    assert_eq!(cache_key.account_id.as_deref(), Some("account_id"));
